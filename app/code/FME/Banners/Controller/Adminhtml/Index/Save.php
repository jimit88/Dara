   ...
   //  protected $filter;
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('FME\Banners\Model\Banners')->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('fme_banners');
            ...
            $this->dataPersistor->set('fme_banners', $data);
