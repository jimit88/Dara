...
class CustomOptions extends OriginalCustomOptions{
            ...
            'children' => [
                'record' => [
                    ...
                    'children' => [
						...
						'parent_options_values' => $this->getComplexOptionFieldConfig(55, ['fit' => true]),
     ...
     * @return array
     */
	protected function getComplexOptionFieldConfig($sortOrder, array $config = [])
    {
        return array_replace_recursive(
            [
                'arguments' => [
                    'data' => [
                        'config' => [
                            ...
                            'componentType' => Field::NAME,
                            'formElement' => Select::NAME,
                            'dataScope' => 'complex_option',
							/*'dataScope' => static::FIELD_PRICE_TYPE_NAME_ID,*/
                            'dataType' => Text::NAME,
                            'sortOrder' => $sortOrder,
							/*'value' => '1',
							'valueMap' => [
    ...
    {	
		$group = array();
		/*$group[] = array("value" => '3', "label" => ' ');*/
		$group[] = array("value" => 1, "label" => "Enabled");
		$group[] = array("value" => 0, "label" => "Disabled");
		$group = $group;	
		return $group;
	}
