...
class Slider extends \Magento\Backend\Block\Widget\Grid\Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    {
        /** @var \Plumtree\Complexgrd\Model\ResourceModel\Slider\Collection $collection */
    ...
    /**
     * @param \Plumtree\Complexgrd\Model\Slider|\Magento\Framework\Object $item
     * @return string
     */
    ...
    {
        return $this->coreRegistry->registry('plumtree_complexgrd_banner');
    }
    ...
    {
        return $this->getUrl('plumtree_complexgrd/banner/sliders', ['_current' => true]);
    }
