...
//use Plumtree\Complexgrd\Model\ProductsFactory;
use Plumtree\Complexgrd\Model\BannerFactory;
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
     ...
     * @param ProductstFactory $attachmentFactory
    ...
    protected function _prepareColumns()
    {
        ...
        $model = $this->_objectManager->get('\Plumtree\Complexgrd\Model\Products');
    ...
    {
        $contactId = $this->getRequest()->getParam('banner_id');
