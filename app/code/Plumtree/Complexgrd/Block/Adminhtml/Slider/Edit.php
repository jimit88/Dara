 ...
 */
namespace Plumtree\Complexgrd\Block\Adminhtml\Slider;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        parent::_construct();
        $this->buttonList->update('save', 'label', __('Save Options'));
        $this->buttonList->add(
            'save-and-continue',
            [
    ...
    public function getHeaderText()
    {
        ...
        $slider = $this->coreRegistry->registry('plumtree_complexgrd_slider');
        if ($slider->getId()) {
