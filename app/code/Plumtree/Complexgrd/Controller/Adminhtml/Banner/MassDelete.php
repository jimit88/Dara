...
class MassDelete extends \Magento\Backend\App\Action
{
     ...
     * @param \Plumtree\Complexgrd\Model\ResourceModel\Banner\CollectionFactory $collectionFactory
     * @param \Magento\Backend\App\Action\Context $context
     */
    public function __construct(
        \Magento\Ui\Component\MassAction\Filter $filter,
        \Plumtree\Complexgrd\Model\ResourceModel\Banner\CollectionFactory $collectionFactory,
    ...
    public function execute()
    {
        ...
        foreach ($collection as $item) {
            /** @var \Plumtree\Complexgrd\Model\Banner $item */
            $item->delete();
            $delete++;
        }
