...
class Delete extends \Plumtree\Complexgrd\Controller\Adminhtml\Banner
{
    /**
     * execute action
     *
        ...
        if ($id) {
            ...
            try {
                ...
                $this->_eventManager->dispatch(
                    'adminhtml_plumtree_complexgrd_banner_on_delete',
                ...
                $resultRedirect->setPath('plumtree_complexgrd/*/edit', ['banner_id' => $id]);
                return $resultRedirect;
            }
        }
        // display error message
