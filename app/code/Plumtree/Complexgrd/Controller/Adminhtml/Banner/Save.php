...
class Save extends \Plumtree\Complexgrd\Controller\Adminhtml\Banner
{
    /**
	extends \Magento\Backend\App\Action 
	extends \Plumtree\Complexgrd\Controller\Adminhtml\Banner
     * Upload model
     * 
     * @var \Plumtree\Complexgrd\Model\Upload
     */
     ...
     * Image model
     * 
     * @var \Plumtree\Complexgrd\Model\Banner\Image
     */
     ...
     * constructor
     * 
     * @param \Plumtree\Complexgrd\Model\Upload $uploadModel
     * @param \Plumtree\Complexgrd\Model\Banner\Image $imageModel
    ...
    public function __construct(
        \Plumtree\Complexgrd\Model\Upload $uploadModel,
        \Plumtree\Complexgrd\Model\Banner\Image $imageModel,
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $this->_eventManager->dispatch(
                'plumtree_complexgrd_banner_prepare_save',
                [
                    'banner' => $banner,
			...
			$model = $this->_objectManager->create('Plumtree\Complexgrd\Model\Products');
			$model->setData($_data);
            try {
			...
			die;*/
                ...
                $this->_session->setPlumtreeComplexgrdBannerData(false);
            ...
            $this->_getSession()->setPlumtreeComplexgrdBannerData($data);
            $resultRedirect->setPath(
                'plumtree_complexgrd/*/edit',
                [
                    'banner_id' => $banner->getId(),
        ...
        if (isset($post['products'])) {
            ...
            try {
				...
				*/
                ...
                $table = 'jh_mageplaza_product_attachment_rel'; // $this->_resources->getTableName(\Webspeaks\ProductsGrid\Model\ResourceModel\Contact::TBL_ATT_PRODUCT);
