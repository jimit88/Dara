...
class Slider extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'plumtree_complexgrd_slider';
     ...
     * @var string
     */
    protected $_cacheTag = 'plumtree_complexgrd_slider';
     ...
     * @var string
     */
    protected $_eventPrefix = 'plumtree_complexgrd_slider';

    /**
     * Banner Collection
     * 
     * @var \Plumtree\Complexgrd\Model\ResourceModel\Banner\Collection
     */
    ...
    {
        $this->_init('Plumtree\Complexgrd\Model\ResourceModel\Slider');
    }
    ...
    /**
     * @return \Plumtree\Complexgrd\Model\ResourceModel\Banner\Collection
     */
    public function getSelectedBannersCollection()
    {
        if (is_null($this->bannerCollection)) {
            ...
            $collection->join(
                ...
                'main_table.banner_id=plumtree_complexgrd_banner_slider.banner_id AND plumtree_complexgrd_banner_slider.slider_id='.$this->getId(),
                ['position']
            );
