...
- User Guide: https://docs.plumtree.com/banner-slider-m2/
- Report bug: https://github.com/plumtree/magento-2-banner-slider/issues
- Discussions: http://magento.stackexchange.com/
- Contribute on Github: https://github.com/plumtree/magento-2-banner-slider
- Product Page: https://www.plumtree.com/magento-2-banner-slider-extension/
...
![banner slider](https://www.plumtree.com/assets/img/extensions-images/magento-2-banner-slider/demo_2.png)
...
![banner slider](https://www.plumtree.com/assets/img/extensions-images/magento-2-banner-slider/demo.png)
...
- Fully compatible with Plumtree extensions
...
![plumtree banner slider](https://i.imgur.com/wjRuf5O.png)
...
```
{{ block class="Plumtree\Complexgrd\Block\Slider" template="Plumtree_Complexgrd::slider.phtml" banner_id="1" }}
```
...
<page xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="../../../../../../../lib/internal/Magento/Framework/View/	Layout/etc/page_configuration.xsd">
    <referenceContainer name="content">
        <block template="slider.phtml" class="Plumtree\Complexgrd\Block\Slider" name="plumtree_complexgrd"/>
    </referenceContainer>
</page>
```
...
## Why Plumtree developed this module for Developers
