...
namespace Plumtree\SocialButtons\Block;
...
class SocialButtons extends \Magento\Framework\View\Element\Template {
	...
	public function canEmailToFriend()
	{
	 ...
	 return $this->_scopeConfig->getValue('socialbuttons/email/enable', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
	}
	public function showDropbox()
	{
		return $this->_scopeConfig->getValue('socialbuttons/dropbox/enable', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
	}
}
