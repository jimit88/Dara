...
namespace Plumtree\Shippingpdf\Model\Order\Pdf;
...
class Shipment extends  \Magento\Sales\Model\Order\Pdf\Shipment 
{
 ...
 public function getPdf($shipments = [])
	...
	protected function insertLogo(&$page, $store = null)
    {
        ...
        if ($image) {
            ...
            if ($this->_mediaDirectory->isFile($imagePath)) {
                ...
                $y1 = $top - $height;
                $y2 = $top;
                $x1 = 162; // logo center position in pdf
                $x2 = $x1 + $width;
	...
	protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
		...
		$page->drawText($payment[0], $paymentLeft, $yPayments, 'UTF-8');	
        ...
        if ($order->getIsVirtual()) {
            ...
            if (count($tracks)) {
				if ($shippingMethod == 'United Parcel Service - UPS Three-Day Select'){
					$page->setFillColor(new \Zend_Pdf_Color_Rgb(0.93, 0.92, 0.92));
					$page->setLineWidth(0.5);
			...
			if ($shippingMethod == 'United Parcel Service - UPS Three-Day Select'){
				...
				$page->drawLine(25, $methodStartY, 25, $this->y);
				//left
