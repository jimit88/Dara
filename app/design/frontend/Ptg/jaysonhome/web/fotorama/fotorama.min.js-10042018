...
if(jQuery("body").hasClass("fotorama__fullscreen")){width=main_img_width}else if(jQuery("body").hasClass("weltpixel-quickview-catalog-product-view")){width=732}else{width=measures.W=measures.w=$wrap.width()}
